 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, avetter
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_ListIteratorAddA_A, "emptyList_ListIteratorAddA_A", LIST_A, STRING_A);
		...
		testEmptyList(A_ListIterator1PreviousRemove_emptyList, "A_ListIterator1PreviousRemove_emptyList");
		...
		testTwoElementList(A_ListIteratorAddB_BA, "A_ListIteratorAddB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_ListIterator1PreviousAddB_BA, "A_ListIterator1PreviousAddB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_ListIteratorNextAddB_AB, "A_ListIteratorNextAddB_AB", LIST_AB, STRING_AB);
		...
		testSingleElementList(A_set0C_C, "A_set0C_C", LIST_C, STRING_C);
		testSingleElementList(A_ListIterNextSetB_B, "A_ListIterNextSetB_B", LIST_B, STRING_B);
		testSingleElementList(A_ListIter1PreviousSetB_B, "A_ListIter1PreviousSetB_B", LIST_B, STRING_B);
 
		//2-element to 1-element
        testSingleElementList(AB_removeFirst_B, "A_removeFirst_B", LIST_B, STRING_B);
		...
		testSingleElementList(AB_listIter1RemoveA_B, "AB_listIter1RemoveA_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_ListIteratorAddC_CAB, "AB_ListIteratorAddC_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_ListIteratorPreviousAddC_CAB, "AB_ListIteratorPreviousAddC_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_ListIteratorNextNextAddC_ABC, "AB_ListIteratorNextNextAddC_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_ListIter2PreviousAddC_ACB , "AB_ListIter2PreviousAddC_ACB ", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_ListIteratorNextAddC_ACB, "AB_ListIteratorNextAddC_ACB", LIST_ACB, STRING_ACB);
		...
		testTwoElementList(AB_ListIter1NextSetC_AC, "AB_ListIter1NextSetC_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_ListIter1PreviousSetC_CB, "AB_ListIter1PreviousSetC_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_ListIter2PreviousSetC_AC, "AB_ListIter2PreviousSetC_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_ListIterNextSetC_CB, "AB_ListIterNextSetC_CB", LIST_CB, STRING_CB);
		
		//3-element to 2-element
        testTwoElementList(ABC_removeLast_AB, "A_addToRearB_AB", LIST_AB, STRING_AB);
		...
		testTwoElementList(ABC_ListIter3PreviousRemove_AB, "ABC_ListIter3PreviousRemove_AB", LIST_AB, STRING_AB);
		testTwoElementList(ABC_ListIter2PreviousRemove_AC, "ABC_ListIter2PreviousRemove_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_ListIter1PreviousRemove_BC, "ABC_ListIter1PreviousRemove_BC", LIST_BC, STRING_BC);
        ...
        testThreeElementList(ABC_set1D_ABD, "ABC_set1D_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_ListIter2PrevioiusSetD_ADC, "ABC_ListIter2PrevioiusSetD_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_ListIter1PrevioiusSetD_DBC, "ABC_ListIter1PrevioiusSetD_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_ListIterNextSetD_DBC, "ABC_ListIterNextSetD_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_ListIter2NextSetD_ABD, "ABC_ListIter2NextSetD_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_ListIter1NextSetD_ADC, "ABC_ListIter1NextSetD_ADC", LIST_ADC, STRING_ADC);
...
//			break;
    ...
    /**
     * Scenario: [A,B] -> removeFirst(B) -> [B]
     * @return [B] after removeFirst(B)
     */
	...
	private Scenario<Integer> ABC_set1D_ABD = () -> ABC_set1D_ADC();
    ...
    /** Scenario: [A, B] -> AB_IterRemoveA_B -> [A] 
	 * @return [B] after AB_IterRemoveA_B
	 */
    ...
    /** Scenario: [A, B, C] -> ABC_IterRemoveC_AB -> [A, B] 
	 * @return [A, B] after ABC_IterRemoveC_AB
	 */
	...
	/** Scenario: [A] -> ListIteratorRemoveAfterNextA -> [ ] 
	 * @return [ ] after ListiteratorRemoveAfterNextA
	 */
    ...
    /** Scenario: [A, B] -> AB_ListIterRemoveA_B -> [B] 
	 * @return [B] after AB_ListIterRemoveA_B
	 */
	...
	/** Scenario: [A, B] -> AB_ListIter1Remove_B -> [B] 
	 * @return [B] after AB_ListIter1RemoveA_B
	 */
	private IndexedUnsortedList<Integer> AB_ListIter1RemoveA_B() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
	...
	private Scenario<Integer> AB_listIter1RemoveA_B= () -> AB_ListIter1RemoveA_B();

    /** Scenario: [A, B, C] -> ABC_ListIterRemoveC_AB -> [A, B] 
	 * @return [A, B] after ABC_ListIterRemoveC_AB
	 */
	...
	/** Scenario: [A] -> A_ListIterator1PreviousRemove_emptyList -> [ ] 
	 * @return [ ] after A_ListIterator1PreviousRemove_emptyList
	 */
	...
	/** Scenario: [A, B] -> AB_ListIterator2PreviousRemove_A -> [A] 
	 * @return [A] after AB_ListIterator1PreviousRemove_B
	 */
	private IndexedUnsortedList<Integer> AB_ListIterator1PreviousRemove_B() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> AB_ListIterator1PreviousRemove_B = () -> AB_ListIterator1PreviousRemove_B();

	/** Scenario: [A, B, C] -> ABC_ListIter1PreviousRemove_BC -> [B, C] 
	 * @return [B, C] after ABC_ListIter1PreviousRemove_BC
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter1PreviousRemove_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_ListIter1PreviousRemove_BC = () -> ABC_ListIter1PreviousRemove_BC();

	/** Scenario: [A, B, C] -> ABC_ListIter2PreviousRemove_AC -> [A, C] 
	 * @return [A, C] after ABC_ListIter2PreviousRemove_AC
	 */
	...
	private Scenario<Integer> ABC_ListIter2PreviousRemove_AC = () -> ABC_ListIter2PreviousRemove_AC();

	/** Scenario: [A, B, C] -> ABC_ListIter3PreviousRemove_AB -> [A, B] 
	 * @return [A, B] after ABC_ListIter3PreviousRemove_AB
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter3PreviousRemove_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
	...
	private Scenario<Integer> ABC_ListIter3PreviousRemove_AB = () -> ABC_ListIter3PreviousRemove_AB();

	/** Scenario: empty list -> emptyList_ListIteratorAddA_A -> [A] 
	 * @return [A] after emptyList_ListIteratorAddA_A
	 */
	private IndexedUnsortedList<Integer> emptyList_ListIteratorAddA_A() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.addToFront(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> emptyList_ListIteratorAddA_A = () -> emptyList_ListIteratorAddA_A();

	/** Scenario: [A] -> A_ListIteratorAddB_BA -> [B, A] 
	 * @return [B, A] after A_ListIteratorAddB_BA
	 */
	private IndexedUnsortedList<Integer> A_ListIteratorAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_ListIteratorAddB_BA = () -> A_ListIteratorAddB_BA();

	/** Scenario: [A] -> A_ListIteratorNextAddB_AB -> [A, B] 
	 * @return [A, B] after A_ListIteratorNextAddB_AB
	 */
	private IndexedUnsortedList<Integer> A_ListIteratorNextAddB_AB() {
	...
	private Scenario<Integer> A_ListIteratorNextAddB_AB = () -> A_ListIteratorNextAddB_AB();

	/** Scenario: [A] -> A_ListIterator1PreviousAddB_BA -> [B, A] 
	 * @return [B, A] after A_ListIterator1PreviousAddB_BA
	 */
	private IndexedUnsortedList<Integer> A_ListIterator1PreviousAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_ListIterator1PreviousAddB_BA = () -> A_ListIterator1PreviousAddB_BA();

/** Scenario: [A, B] -> AB_ListIteratorAddC_CAB -> [C, A, B] 
	 * @return [C, A, B] after AB_ListIteratorAddC_CAB 
	 */
	private IndexedUnsortedList<Integer> AB_ListIteratorAddC_CAB () {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_ListIteratorAddC_CAB = () -> AB_ListIteratorAddC_CAB();

	/** Scenario: [A, B] -> AB_ListIteratorNextAddC_ACB -> [A, C, B] 
	 * @return [A, C, B] after AB_ListIteratorAddC_CAB 
	 */
	...
	/** Scenario: [A, B] -> AB_ListIteratorNextNextAddC_ABC -> [A, B, C] 
	 * @return [A, C, B] after AB_ListIteratorNextNextAddC_ABC
	 */
	private IndexedUnsortedList<Integer> AB_ListIteratorNextNextAddC_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_ListIteratorNextNextAddC_ABC = () -> AB_ListIteratorNextNextAddC_ABC();

	/** Scenario: [A, B] -> AB_ListIteratorPreviousAddC_CAB -> [C, A, B] 
	 * @return [C, A, B] after AB_ListIteratorPreviousAddC_CAB 
	 */
	private IndexedUnsortedList<Integer> AB_ListIteratorPreviousAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIteratorPreviousAddC_CAB = () -> AB_ListIteratorPreviousAddC_CAB();
	
	/** Scenario: [A, B] -> AB_ListIter2PreviousAddC_ACB -> [A, C, B] 
	 * @return [A, C, B] after AB_ListIter2PreviousAddC_ACB 
	 */
	private IndexedUnsortedList<Integer> AB_ListIter2PreviousAddC_ACB () {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	/** Scenario: [A] -> A_ListIterNextSetB_B -> [B] 
	 * @return [B] after A_ListIterNextSetB_B
	 */
	...
	private Scenario<Integer> A_ListIterNextSetB_B  = () -> A_ListIterNextSetB_B();


	/** Scenario: [A] -> B_ListIter1PreviousSetB_B -> [B] 
	 * @return [B] after B_ListIter1PreviousSetB_B
	 */
	private IndexedUnsortedList<Integer> A_ListIter1PreviousSetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_ListIter1PreviousSetB_B  = () -> A_ListIter1PreviousSetB_B();


	/** Scenario: [A, B] -> AB_ListIterNextSetC_CB -> [C, B] 
	 * @return [C, B] after AB_ListIterNextSetC_CB 
	 */
	...
	private Scenario<Integer> AB_ListIterNextSetC_CB  = () -> AB_ListIterNextSetC_CB();


	/** Scenario: [A, B] -> AB_ListIter1NextSetC_AC -> [A, C] 
	 * @return [A, C] after AB_ListIter1NextSetC_AC
	 */
	private IndexedUnsortedList<Integer> AB_ListIter1NextSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIter1NextSetC_AC  = () -> AB_ListIter1NextSetC_AC();


	/** Scenario: [A, B] -> AB_ListIter1PreviousSetC_CB -> [C, B] 
	 * @return [C, B] after AB_ListIter1PreviousSetC_CB
	 */
	private IndexedUnsortedList<Integer> AB_ListIter1PreviousSetC_CB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIter1PreviousSetC_CB  = () -> AB_ListIter1PreviousSetC_CB();


	/** Scenario: [A, B] -> AB_ListIter2PreviousSetC_AC -> [A, C] 
	 * @return [A, C] after AB_ListIter2PreviousSetC_AC
	 */
	private IndexedUnsortedList<Integer> AB_ListIter2PreviousSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_ListIter2PreviousSetC_AC  = () -> AB_ListIter2PreviousSetC_AC();


	/** Scenario: [A, B, C] -> ABC_ListIterNextSetD_DBC -> [D, B, C] 
	 * @return [D, B, C] after ABC_ListIterNextSetD_DBC 
	 */
	...
	private Scenario<Integer> ABC_ListIterNextSetD_DBC  = () -> ABC_ListIterNextSetD_DBC ();


	/** Scenario: [A, B, C] -> ABC_ListIter1NextSetD_ADC -> [A, D, C] 
	 * @return [A, D, C] after ABC_ListIter1NextSetD_ADC
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter1NextSetD_ADC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_ListIter1NextSetD_ADC = () -> ABC_ListIter1NextSetD_ADC();


	/** Scenario: [A, B, C] -> ABC_ListIter2NextSetD_ABD -> [A, B, D] 
	 * @return [A, B, D] after ABC_ListIter2NextSetD_ABD
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter2NextSetD_ABD() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_ListIter2NextSetD_ABD = () -> ABC_ListIter2NextSetD_ABD();


	/** Scenario: [A, B, C] -> ABC_ListIterSetD_ADB -> [A, D, C] 
	 * @return [A, D, C] after ABC_ListIterSetD_ADB 
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter1PrevioiusSetD_DBC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_ListIter1PrevioiusSetD_DBC = () ->ABC_ListIter1PrevioiusSetD_DBC();


	/** Scenario: [A, B, C] -> ABC_ListIter2PreviousSetD_ADB -> [A, D, C] 
	 * @return [A, D, C] after ABC_ListIter2PreviousSetD_ADB 
	 */
	private IndexedUnsortedList<Integer> ABC_ListIter2PrevioiusSetD_ADC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_ListIter2PrevioiusSetD_ADC = () ->ABC_ListIter2PrevioiusSetD_ADC();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
            ...
            printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
            //iterator after next()remove()
            printTest(scenarioName + "_iterNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.False));
            ...
            printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemoveNext(scenario.build()), Result.False));
            printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemoveNext(scenario.build()), null, Result.NoSuchElement));
            printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemoveNext(scenario.build()), Result.NoException));

			if (SUPPORTS_LIST_ITERATOR) {
				//make the iter, with and without index parameter
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
				printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
				printTest(scenarioName + "_testListIter1", testListIter(scenario.build(), 1, Result.NoException));
				...
				//immediately test all of the ListIter methods
				printTest(scenarioName + "_testListIterHasNext", testIterHasNext(scenario.build().listIterator(), Result.True));
				printTest(scenarioName + "_testListIterNext", testIterNext(scenario.build().listIterator(), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIterNextIndex", testListIterNextIndex(scenario.build().listIterator(), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIterHasPrevious", testListIterHasPrevious(scenario.build().listIterator(), Result.False));
				...
				//retest some ListIter methods after call to Next
				printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));

				//retest some ListIter methods after calls to Next and then Previous
				printTest(scenarioName + "_testListIterNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));

				//test ListIterator methods starting at index 0
				printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
				printTest(scenarioName + "_testListIter0Next", testIterNext(scenario.build().listIterator(0), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIter0NextIndex", testListIterNextIndex(scenario.build().listIterator(0), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIter0HasPrevious", testListIterHasPrevious(scenario.build().listIterator(0), Result.False));
				...
				//test LI methods starting at index 0 after call to next
				printTest(scenarioName + "_testListIter0NextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(0), 1), Result.NoException));
				printTest(scenarioName + "_testListIter0NextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(0), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(0), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 0 after Next then Previous
				printTest(scenarioName + "_testListIter0NextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIter0NextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 0 after two calls to next followed by a call to previous
				printTest(scenarioName + "_testListIter0NextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1), Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 0 after two calls to Next
				...
				printTest(scenarioName + "_testListIter0NextNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(0), 2), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 1
				...
				//test LI methods starting at index 1 after call to previous
				printTest(scenarioName + "_testListIter1PreviousRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(1), 1), Result.NoException));
				printTest(scenarioName + "_testListIter1PreviousAdd", testListIterAdd(listIterAfterPrevious(scenario.build().listIterator(1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter1PreviousSet", testListIterSet(listIterAfterPrevious(scenario.build().listIterator(1), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 1 after call to previous then next
				printTest(scenarioName + "_testListIter1PreviousNextRemove", testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIter1PreviousNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter1PreviousNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 2
				printTest(scenarioName + "_testListIter2HasNext", testIterHasNext(scenario.build().listIterator(2), Result.False)); //TRUE IMPROVES
				...
				//test LI methods starting at index 2 after call to previous twice
				...
				//test LI methods starting at index 2 after call to previous
				printTest(scenarioName + "_testListIter2PreviousPreviousRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(2), 1), Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(scenario.build().listIterator(2), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter2PreviousPreviousSet", testListIterSet(listIterAfterPrevious(scenario.build().listIterator(2), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 2 after call to previous then next
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
            ...
            printTest(scenarioName + "_iterNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
            //iterator after next()remove()next()
            printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemoveNext(scenario.build()), Result.True));
            printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemoveNext(scenario.build()), contents[2], Result.MatchingValue));
            printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemoveNext(scenario.build()), Result.NoException));
            //iterator after next()next()remove()next()
            printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext((iterAfterNextNextRemoveNext(scenario.build())), Result.False));
            printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterAfterNextNextRemoveNext(scenario.build()), null, Result.NoSuchElement));
            printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextNextRemoveNext(scenario.build()), Result.NoException));
            //iterator after next()next()next()
            ...
            //iterator after next()next()next()remove()
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				//test LI methods starting at index 2 after call to Next
				...
				printTest(scenarioName + "_testListIter2NextHasNext", testIterHasNext(listIterAfterNext(scenario.build().listIterator(2), 1), Result.False));
				...
				//test LI methods starting at index 3 after call to previous twice
				...
				//test LI methods starting at index 3 after call to previous three times
				...
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousSet", testListIterHasPrevious(listIterAfterPrevious(scenario.build().listIterator(3), 3), Result.False));


				//test LI methods starting at index 3 after call to previous
				printTest(scenarioName + "_testListIter3PreviousPreviousRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(3), 1), Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(scenario.build().listIterator(3), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter3PreviousPreviousSet", testListIterSet(listIterAfterPrevious(scenario.build().listIterator(3), 1), ELEMENT_X, Result.NoException));

				//test LI methods starting at index 3 after call to previous then next
    ...
    /** Helper for testing iterators. Return an Iterator that has been advanced once, called remove(), and advanced again.
	 * @param list
	 * @return Iterator for given list, after numCallsToNext
	 */
	private Iterator<Integer> iterAfterNextRemoveNext(IndexedUnsortedList<Integer> list) {
		Iterator<Integer> it = list.iterator();
		it.next();
        it.remove();
        it.next();
    ...
    /** Helper for testing iterators. Return an Iterator that has been advanced twice, called remove(), and advanced again.
	 * @param list
	 * @return Iterator for given list, after numCallsToNext
	 */
	private Iterator<Integer> iterAfterNextNextRemoveNext(IndexedUnsortedList<Integer> list) {
		Iterator<Integer> it = list.iterator();
		it.next();
        it.next();
        it.remove();
